// Edit by Maxim_S
// Copies X/Y origins, and also Special types and Animation speeds.
...
foreach (var sprite in Data.Sprites)
{
    ...
    if (donorSpr is not null)
    {
		...
		sprite.GMS2PlaybackSpeedType = donorSpr.GMS2PlaybackSpeedType;
		sprite.GMS2PlaybackSpeed = donorSpr.GMS2PlaybackSpeed;
		sprite.IsSpecialType = donorSpr.IsSpecialType;
		sprite.SVersion = donorSpr.SVersion;
    }
}
