...
{
    if (pizzaface_sprite == global.mod_spr_timer_pizzaface1)
    {
        pizzaface_sprite = global.mod_spr_timer_pizzaface2
        pizzaface_index = 0
    }
    else if (pizzaface_sprite == global.mod_spr_timer_pizzaface2)
    {
        if (floor(pizzaface_index) == (sprite_get_number(pizzaface_sprite) - 1))
        {
            pizzaface_sprite = global.mod_spr_timer_pizzaface3
            pizzaface_index = 0
        }
    }
...
{
    pizzaface_sprite = global.mod_spr_timer_pizzaface1
