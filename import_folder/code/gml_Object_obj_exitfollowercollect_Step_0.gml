if (((obj_player1.ispeppino && !global.swapmode) || (object_index == obj_gustavofollower && global.swapmode) || object_index == obj_stickfollower || object_index == obj_noisefollower || object_index == obj_noisettefollower) && global.panic && !global.exitrank && distance_to_object(obj_player1) <= (is_toppingal ? 5 : 300) && ds_list_find_index(global.saveroom, id) == -1)
{
    ...
    with (instance_create(x, y, obj_exitfollower))
    {
        ...
        if (other.object_index == obj_toppinshroomexit)
        {
            xoffset = 40
            global.exit_toppin_shroom = 1
            tv_do_expression(spr_tv_toppinshroom)
        }
        
        if (other.object_index == obj_toppincheeseexit)
        {
            xoffset = 40
            global.exit_toppin_cheese = 1
            tv_do_expression(spr_tv_toppincheese)
        }
        
        if (other.object_index == obj_toppintomatoexit)
        {
            xoffset = 40
            global.exit_toppin_tomato = 1
            tv_do_expression(spr_tv_toppintomato)
        }
        
        if (other.object_index == obj_toppinsausageexit)
        {
            xoffset = 40
            global.exit_toppin_sausage = 1
            tv_do_expression(spr_tv_toppinsausage)
        }
        
        if (other.object_index == obj_toppinpineappleexit)
        {
            xoffset = 40
            global.exit_toppin_pineapple = 1
            tv_do_expression(spr_tv_toppinpineapple)
        }
