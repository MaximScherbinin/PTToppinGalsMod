function scr_pauseicon_draw(argument0, argument1, argument2) //gml_Script_scr_pauseicon_draw
{
    ...
    draw_sprite_ext((global.mod_femgerome ? spr_pauseicons_femgerome : icon.sprite_index), icon.image_index, (argument1 + icon.sprite_xoffset + icon.shake_x), (argument2 + icon.sprite_yoffset + icon.shake_y), 1, 1, 0, c_white, icon.image_alpha)
}
