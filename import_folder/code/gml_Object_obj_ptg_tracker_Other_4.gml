...
if (room == plage_cavern2)
{
    ...
    var _spr_ptg = (global.mod_pizzatowergal == 1) ? 4738 : 4739
    layer_sprite_change(sprite_i, _spr_ptg)
}

if (room == tower_mansion)
{
    var lay_id = layer_create(90, "Assets_1")
...
if (global.mod_graceball)
{
    ...
    {
        var lay_id = layer_create(90, "Assets_3")
        var spr = spr_tile_beach_graceball
        layer_sprite_create(lay_id, 8161, 266, spr)
    }
    
    if (room == plage_beach2)
    {
        var lay_id = layer_create(90, "Assets_2")
        var spr = spr_tile_beach_graceball
    ...
    if (room == minigolf_8)
    {
        var lay_id = layer_get_id("Backgrounds_zigzag1")
        var back_id = layer_background_get_id(lay_id)
